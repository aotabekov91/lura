...
class Display(QScrollArea):
    ...
    def __init__(self, parent):
        ...
        self.colorCode=self.config['colorSystem']
        self.location = 'right'
    ...
    def setup(self):
        ...
        self.app.window.mapItemChanged.connect(self.on_mapItemChanged)
    ...
    def load(self, did=None, function=None):
        ...
        if did is None: 
            if self.app.window.view() is None: return
        ...
        annotations = self.app.tables.get(
        ...
        for annotation in self.m_annotations:
            ...
            aWidget = AQWidget(annotation['id'], self.app.window)
