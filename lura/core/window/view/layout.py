...
class SinglePageLayout:
    ...
    def __init__(self, settings):
        ...
        self.viewportPadding=settings['layout']['viewportPadding']

    def visibleWidth(self, viewportWidth):
        pageSpacing=self.s_settings['layout']['pageSpacing']
...
class DocumentLayout:
    ...
    def __init__(self, documentView):
        ...
        self.fromLayoutMode(self.s_settings['layout']['currentMode'])
