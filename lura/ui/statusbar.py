...
class StatusBar(QStatusBar):
    ...
    def installEventFilter(self, listener):
        ...
        self.command_info.installEventFilter(listener)
        self.command_edit.installEventFilter(listener)
        self.page_info.installEventFilter(listener)
        self.detail_info.installEventFilter(listener)
        self.document_info.installEventFilter(listener)

    def removeEventFilter(self, listener):
        super().removeEventFilter(listener)
        self.command_info.removeEventFilter(listener)
        self.command_edit.removeEventFilter(listener)
        self.page_info.removeEventFilter(listener)
        self.detail_info.removeEventFilter(listener)
        self.document_info.removeEventFilter(listener)
    ...
    def setActions(self):
        self.connect()
        self.configure=Configure(self.app, 'Statusbar', self)
