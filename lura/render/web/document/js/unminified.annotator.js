    ...
    return (function e(t, n, r) {
    ...
    })(
        {
            1: [
                ...
                { "./css/annotator.css": 2, "./src/app": 22, "./src/authz": 23, "./src/identity": 24, "./src/notification": 25, "./src/storage": 27, "./src/ui": 28, "./src/util": 39, "insert-css": 16 },
            ],
            2: [
                function (require, module, exports) {
                    module.exports =`
...
.annotator-viewer div {
    ...
    border-top: 1px solid rgba(133, 133, 133, .11)
}
...
.annotator-filter .annotator-filter-navigation button {
    ...
    background-image: -webkit-gradient(linear, left top, left bottom, from(#f5f5f5), color-stop(.6, #dcdcdc), to(#d2d2d2));
    ...
    -webkit-box-shadow: inset 1px 0 0 rgba(255, 255, 255, .7), inset -1px 0 0 rgba(255, 255, 255, .7), inset 0 1px 0 rgba(255, 255, 255, .7);
    -moz-box-shadow: inset 1px 0 0 rgba(255, 255, 255, .7), inset -1px 0 0 rgba(255, 255, 255, .7), inset 0 1px 0 rgba(255, 255, 255, .7);
    -o-box-shadow: inset 1px 0 0 rgba(255, 255, 255, .7), inset -1px 0 0 rgba(255, 255, 255, .7), inset 0 1px 0 rgba(255, 255, 255, .7);
    box-shadow: inset 1px 0 0 rgba(255, 255, 255, .7), inset -1px 0 0 rgba(255, 255, 255, .7), inset 0 1px 0 rgba(255, 255, 255, .7);
...
.annotator-filter .annotator-filter-property label {
    ...
    background-color: #d4d4d4;
    background-image: -webkit-gradient(linear, left top, left bottom, from(#f5f5f5), color-stop(.5, #d2d2d2), color-stop(.5, #bebebe), to(#d2d2d2));
    ...
    -webkit-box-shadow: inset 0 0 5px rgba(255, 255, 255, .2), inset 0 0 1px rgba(255, 255, 255, .8);
...
.annotator-filter .annotator-filter-navigation button:hover {
    ...
    background-image: -webkit-gradient(linear, left top, left bottom, from(#7691fb), color-stop(.5, #5075fb), color-stop(.5, #3865f9), to(#3665fa));
...
.annotator-filter .annotator-filter-navigation button:active {
    ...
    background-image: -webkit-gradient(linear, left top, left bottom, from(#fc7cca), color-stop(.5, #e85db2), color-stop(.5, #d12e8e), to(#ff009c));
...
.annotator-hl-filtered {
    background-color: transparent
            ...
            11: [
                ...
                { "./all": 6, "./asap": 7, "./cast": 8, "./config": 9, "./race": 12, "./reject": 13, "./resolve": 14, "./utils": 15 },
            ],
            12: [
                function (require, module, exports) {
                    "use strict";
            ...
            18: [
                function (require, module, exports) {
                    (function () {
                        module.exports = { xpath: require("./xpath"), Range: require("./range") };
                    }.call(this));
                },
                { "./range": 19, "./xpath": 21 },
            ],
            ...
            21: [
                function (require, module, exports) {
                    (function () {
                        ...
                        module.exports = { fromNode: fromNode, toNode: toNode };
                    }.call(this));
                },
                { "./util": 20, jquery: 17 },
            ],
            22: [
                ...
                { "./authz": 23, "./identity": 24, "./notification": 25, "./registry": 26, "./storage": 27, "backbone-extend-standalone": 3, "es6-promise": 5 },
            ],
            23: [
                function (require, module, exports) {
                    "use strict";
            ...
            25: [
                function (require, module, exports) {
                    (function (global) {
                        ...
                        var bannerClasses = { show: "annotator-notice-show", info: "annotator-notice-info", success: "annotator-notice-success", error: "annotator-notice-error" };
            ...
            27: [
                function (require, module, exports) {
                    ...
                    HttpStorage.prototype._methodFor = function (action) {
                        var table = { create: "POST", update: "PUT", destroy: "DELETE", search: "GET" };
                        return table[action];
                    };
                    ...
                    HttpStorage.options = {
                        ...
                        prefix: "/store",
                        urls: { create: "/annotations", update: "/annotations/{id}", destroy: "/annotations/{id}", search: "/search" },
                    };
            ...
            28: [
                ...
                { "./ui/adder": 29, "./ui/editor": 30, "./ui/filter": 31, "./ui/highlighter": 32, "./ui/main": 33, "./ui/markdown": 34, "./ui/tags": 35, "./ui/textselector": 36, "./ui/viewer": 37, "./ui/widget": 38 },
            ],
            29: [
                function (require, module, exports) {
                    "use strict";
					...
					'  <button type="button">' + _t("Annotate") + "</button>", "</div>",

					].join("\n");
                    Adder.options = { onCreate: null };
                    exports.Adder = Adder;
                },
                { "../util": 39, "./widget": 38 },
            ],
                ...
                function (require, module, exports) {
                    ...
                    var dragTracker = (exports.dragTracker = function dragTracker(handle, callback) {
                        ...
                        function mouseMove(e) {
                            ...
                            var delta = { y: e.pageY - lastPos.top, x: e.pageX - lastPos.left };
                            var trackLastMove = true;
                            if (typeof callback === "function") {
                                trackLastMove = callback(delta);
                            }
                            if (trackLastMove !== false) {
                                lastPos = { top: e.pageY, left: e.pageX };
                            }
                            throttled = true;
                            setTimeout(function () {
                                throttled = false;
                    ...
                    var resizer = (exports.resizer = function resizer(element, handle, options) {
                        ...
                        function translate(delta) {
                            ...
                            return { x: delta.x * directionX, y: delta.y * directionY };
                        }
                    ...
                    var mover = (exports.mover = function mover(element, handle) {
                        function move(delta) {
                            $(element).css({ top: parseInt($(element).css("top"), 10) + delta.y, left: parseInt($(element).css("left"), 10) + delta.x });
                        }
                    ...
                    var Editor = (exports.Editor = Widget.extend({
                        constructor: function (options) {
                            ...
                            if (this.options.defaultFields) {
                                ...
                                this.addField({
                                    type: "select",
                                    load: function (field, annotation) {
										$(field).find('select').val(annotation.color);
                                    },
                                    submit: function (field, annotation) {
										var color=$(field).find('select').val();
                        ...
                        addField: function (options) {
                            var field = $.extend({ id: "annotator-field-" + id(), type: "input", label: "", load: function () {}, submit: function () {} }, options);
                            var input = null,
                            ...
                            if (field.type === "textarea") {
								...
								this.select=[
									...
									'    <option value="#A4DE02" selected>Focus</option>',
									'    <option value="#c8d9e8">Question</option>',
									'    <option value="#EEFC5E">Definition</option>',
									'    <option value="#D3D3D3">Literature</option>',
									'</select>',
								].join("\n")
                            ...
                            if (field.type === "select") {
                                element.addClass("annotator-color-select");
                                element.append($("<label />", { for: field.id, html: field.label }));
                            }
                    ...
                    Editor.classes = { hide: "annotator-hide", focus: "annotator-focus" };
                    Editor.template = [
                    ...
                    Editor.options = { defaultFields: true };
            ...
            31: [
                function (require, module, exports) {
                    ...
                    Filter.prototype.addFilter = function (options) {
                        var filter = $.extend({ label: "", property: "", isFiltered: this.options.isFiltered }, options);
                        ...
                        if (!hasFilterForProp) {
                            ...
                            filter.element.find("input").attr({ id: filter.id, placeholder: _t("Filter by ") + filter.label + "…" });
                    ...
                    Filter.prototype._scrollToHighlight = function (highlight) {
                        ...
                        $("html, body").animate({ scrollTop: highlight.offset().top - (this.element.height() + 20) }, 150);
                    };
                    Filter.prototype._onClearClick = function (event) {
                        $(event.target).prev("input").val("").keyup().blur();
                    };
                    Filter.classes = { active: "annotator-filter-active", hl: { hide: "annotator-hl-filtered", active: "annotator-hl-active" } };
                    Filter.html = {
                        element: [
            ...
            32: [
                function (require, module, exports) {
                    (function (global) {
                        ...
                        var $ = util.$;
                        var Promise = util.Promise;
                        function highlightRange(normedRange, cssClass, color) {
                            ...
                            for (var i = 0, len = nodes.length; i < len; i++) {
                                ...
                                if (!white.test(node.nodeValue)) {
									...
									if (color !== null) { hl.style.background=color};
                        ...
                        Highlighter.prototype.draw = function (annotation) {
                            ...
                            for (var j = 0, jlen = normedRanges.length; j < jlen; j++) {
								...
								var highlightedRange=highlightRange(normed, this.options.highlightClass, annotation.color)
                                $.merge(annotation._local.highlights, highlightedRange);
                            }
                        ...
                        Highlighter.prototype.redraw = function (annotation) {
							window.alert(annotation.color);
                            this.undraw(annotation);
                            return this.draw(annotation);
                        };
                        Highlighter.options = { highlightClass: "annotator-hl", chunkSize: 10, chunkDelay: 10 };
            ...
            35: [
                function (require, module, exports) {
                    ...
                    exports.editorExtension = function editorExtension(e) {
                        ...
                        field = e.addField({ label: _t("Add some tags here") + "…", load: updateField, submit: setAnnotationTags });
            ...
            36: [
                function (require, module, exports) {
                    (function (global) {
                        ...
                        TextSelector.options = { onSelection: null };
            ...
            37: [
                function (require, module, exports) {
                    ...
                    var Viewer = (exports.Viewer = Widget.extend({
                        ...
                        addField: function (options) {
                            var field = $.extend({ load: function () {} }, options);
                            field.element = $("<div />")[0];
                            this.fields.push(field);
                            return this;
                        },
                    ...
                    Viewer.classes = { showControls: "annotator-visible" };
                    ...
                    (function (global) {
                        ...
                        Widget.prototype.checkOrientation = function () {
                            ...
                            var $win = $(global),
                                ...
                                viewport = { top: $win.scrollTop(), right: $win.width() + $win.scrollLeft() },
                        ...
                        Widget.classes = { hide: "annotator-hide", invert: { x: "annotator-invert-x", y: "annotator-invert-y" } };
                        Widget.template = "<div></div>";
                        Widget.options = { appendTo: "body" };
                ...
                function (require, module, exports) {
                    (function (global) {
                        ...
                        function mousePosition(event) {
                            ...
                            return { top: event.pageY - offset.top, left: event.pageX - offset.left };
                        }
                        exports.$ = $;
                        exports.Promise = Promise;
